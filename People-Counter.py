...
while True:
    ...
    img = pyresearch.overlayPNG(img, imgGraphics, (730, 260))
    ...
    # # pyresearch.putTextRect(img, f' Count: {len(totalCount)}', (50, 50))
    cv2.putText(img,str(len(totalCountUp)),(929,345),cv2.FONT_HERSHEY_PLAIN,5,(256,256,75),7)
